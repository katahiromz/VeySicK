...
|----------:|:-------------------------------|:------------------|:-----------------|
|`0`        |  カラーモード                  |  640×200ピクセル | `4`              |
|`1`        |  白黒モード                    |  640×200ピクセル | `12`             |
|`2`        |  高分解能白黒モード            |  640×400ピクセル | `6`              |
|`3`        |  カラーモード(日本語)          |  640×200ピクセル | `1`              |
|`4`        |  専用ディスプレイモード(日本語)|  640×400ピクセル | `1`              |
...
|表示ページ         |カラーモード     |白黒モード               |高分解能白黒モード   |高分解能カラーモード |
|------------------:|:----------------|:------------------------|:--------------------|:--------------------|
...
8801の場合は、*表示ページ*は以下の意味になります(8801のみ)。

|表示ページ    |カラーモード       |白黒モード                    |高分解能白黒モード      |カラーモード(日本語)  |専用ディスプレイモード(日本語) |
|-------------:|:------------------|:-----------------------------|:-----------------------|:---------------------|:------------------------------|
|`0`           |ページ1のみ表示    |全ページ非表示                |全ページ非表示          |ページ1のみ表示       |ページ1のみ表示                |
|`1`           |ページ1のみ表示    |ページ1のみ表示               |ページ1のみ表示         |ページ1のみ表示       |ページ1のみ表示                |
|`2`           |ページ1のみ表示    |ページ2のみ表示               |ページ2のみ表示         |ページ1のみ表示       |ページ1のみ表示                |
|`3`           |ページ1のみ表示    |ページ1,2を合成表示           |ページ1,2を合成表示     |ページ1のみ表示       |ページ1のみ表示                |
|`4`           |ページ1のみ表示    |ページ3のみ表示               |ページ3のみ表示         |ページ1のみ表示       |ページ1のみ表示                |
|`5`           |ページ1のみ表示    |ページ1,3を合成表示           |ページ1,3を合成表示     |ページ1のみ表示       |ページ1のみ表示                |
|`6`           |ページ1のみ表示    |ページ2,3を合成表示           |ページ2,3を合成表示     |ページ1のみ表示       |ページ1のみ表示                |
|`7`           |ページ1のみ表示    |ページ1,2,3を合成表示         |ページ1,2,3を合成表示   |ページ1のみ表示       |ページ1のみ表示                |

`SCREEN`を実行すると、[論理ウィンドウ](#viewport)、[ビューポート](#viewport)、[LP](#lp)は初期状態に戻ります。LPの初期状態は(0,0)です。
- 【注意】 VeySicKでは8801の専用ディスプレイモード(日本語)は対応していません。
